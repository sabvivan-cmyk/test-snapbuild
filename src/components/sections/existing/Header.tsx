    ...
    <header className={`site-header${open ? ' is-open' : ''}`}>
      <div className="site-header__bar">
        ...
        <nav className="site-nav" aria-label="Основная навигация">
          {[navigation[1], navigation[0], navigation[2], navigation[3]].map((item) => (
        ...
        <div className="site-header__actions">
          <ButtonLink className="site-header__cta" href="https://builder.snapbuild.ru/">
            Начать сейчас
          </ButtonLink>
          <button
      ...
      <nav className="mobile-menu" id="mobile-menu" aria-hidden={!open}>
        {navigation.map((item) => (
